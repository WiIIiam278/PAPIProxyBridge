...
public final class LiteralPayload extends TemplatePayload {
    ...
    public static final Identifier REQUEST_ID = new Identifier(PAPIProxyBridge.getChannel(true));
    public static final Identifier RESPONSE_ID = new Identifier(PAPIProxyBridge.getChannel(false));
